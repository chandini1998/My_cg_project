...
{	
	...
	if(start==0)
	{
		...
		glColor3f(0,0,1);
		drawBitmapText(3*w/10,5*h/6,0.0,"                      SDM INSTITUTE OF TECHNOLOGY");
		glColor3f(0.7,0,1);
		...
		glColor3f(0.5,0,0.5);
		drawBitmapText(20,155,0.0,"NAME: Chandini U.S Bhatt      (USN:4SU16CS024)");
		drawBitmapText(20,130,0.0,"NAME: Dechamma N.P.           (USN:4SU16CS028)");
		
		glColor3f(0.5,0.2,0.2);
		drawBitmapText(7*w/10+10,150,0.0,"GUIDE NAME: prof. Sneha Shetty ");
...
drawBitmapText(250,50,1.0, "packet sent successfully");
		}
